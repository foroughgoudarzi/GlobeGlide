...
function showExchangeRate() {
    ...
    $("td").eq(0).html("<img id='countryicon' src='./imgGBP.png' alt='UK Currency Image'><span> GBP &nbsp; --> &nbsp; </span> ");
    $("td").eq(1).html(conversionRateGBP + " &nbsp  " + currencyCode);

    $("td").eq(2).html("<img id='countryicon'  src='./imgUS.png' alt='US Currency Image'><span> USD &nbsp; -->&nbsp; </span> ");
    $("td").eq(3).html(conversionRateUSD + " &nbsp  " + currencyCode);

    $("td").eq(4).html("<img id='countryicon'  src='./imgEUR.png'alt='Euro Currency Image'><span> EUR  &nbsp; -->&nbsp; </span>");
